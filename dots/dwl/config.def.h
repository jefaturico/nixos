...
static const char *zkcmd[] = { "foot", "-D", "/home/jefaturico/zettelkasten", "-e", "nvim", "-c", "ObsidianSearch", NULL };
static const char *obsidiancmd[] = { "obsidian", NULL };
static const char *taskwarcmd[] = { "foot", "-e", "taskwarrior-tui", NULL };
static const char *khalcmd[]   = { "foot", "-e", "khal", "interactive", NULL };
...
static const Key keys[] = {
        ...
        { MODKEY,                    XKB_KEY_c,      spawn,            {.v = taskwarcmd} },
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_C,      spawn,            {.v = khalcmd} },
